...
#https://www.tensorflow.org/tutorials/structured_data/feature_columns
dataframe = pd.read_csv('all_merged_1_10.csv')
dataframe['target'] = dataframe['engine_ON'] > 0.3
#dataframe.drop(columns=['engine_ON'], inplace=True)

#dataframe.rename(columns={'batteryvoltage':'target'}, inplace=True)
#dataframe['target'] = (dataframe['batteryvoltage']*10.).astype(int)
